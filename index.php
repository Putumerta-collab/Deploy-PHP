...
<div class="container text-center py-4">
    <h2 class="judul">SMART TEMPLE BERBASIS IOT DENGAN ESP yayayaya<br> 32 UNTUK MENGONTROL LAMPU DAN PENGERAS SUARA PADA PURA DESA <br> STUDI KASUS PURA DESA DESA ADAT PENGULON</h2>
</div>
